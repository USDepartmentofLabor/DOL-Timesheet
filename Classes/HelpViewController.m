 ...
 */
 ...
 - (void)viewDidLoad {
	 ...
	 NSString *path = [[NSBundle mainBundle] pathForResource:NSLocalizedString(@"help-en",@"Help file name without extension") ofType:@"html"];
...
- (id)init {
	if (self = [super initWithNibName:@"HelpViewController" bundle:nil]) {
		self.title = NSLocalizedString(@"Glossary",@"Glossary");
		
		//Tab Bar item
		UITabBarItem *item = [[UITabBarItem alloc] initWithTitle:NSLocalizedString(@"Glossary",@"Glossary") image:[UIImage imageNamed:@"glossary-icon.png"] tag:3];
